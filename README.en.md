...
- **Human checkpoint at kickoff**: the proposal is laid out to the user for item-by-item confirmation (covering five known weak spots: secondary text color, neutral ink, dark tokens, the CJK font stack, and the monospace font stack) before it is written to disk; without confirmation, no DESIGN.md is produced.
